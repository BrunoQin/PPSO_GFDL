...
public class Constants {
    ...
    // PCA相关参数设置
    public static final String PCA_PATH             =   DATA_PATH + "ta_oct_400Y_Lev21.nc";
    public static final String PCA_NO_NAN_PATH      =   DATA_PATH + "ta_jan_no_nan.nc";
    public static final String PCA_PARAMETER        =   "ta_oct";
    ...
    public static final String PCA_U                =   "u.oct." + EXP_NAME + ".txt";
    public static final String PCA_S                =   "s.oct." + EXP_NAME + ".txt";
    ...
    public static final String STANDARD_FILENAME    =   DATA_PATH + "426.9.nc";
    public static final String STD_FILENAME         =   DATA_PATH + "std_oct_" + EXP_NAME + ".nc";
    public static final String STD_PARAMETER        =   "std_oct";
