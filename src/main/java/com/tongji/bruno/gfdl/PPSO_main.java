...
//
//        for(int j = 0; j < 80; j++){
//            tem[j][0] =  FileHelper.readFile("D:\\github\\PPSO_GFDL\\src\\main\\resources\\0.txt")[j];
//        }
//
//        Matrix p = new Matrix(tem);

//        Matrix ssta = lambdaMatrix.times(p);

////        lambdaMatrix.print(4, 8);
//
...
//        double[] tem = FileHelper.readFile("D:\\github\\PPSO_GFDL\\src\\main\\resources\\v0.txt");
//
...
//        double[][] tem = FileHelper.getSigma();
//
//        for(int i = 0; i < 200; i++){
//            for(int j = 1; j < 2; j++){
...
//        FileHelper.prepareFile(8, null);

//        System.out.println(lambdaMatrix.getColumnDimension());
//        System.out.println(lambdaMatrix.getRowDimension());
